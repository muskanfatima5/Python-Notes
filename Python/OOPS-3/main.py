# BASIC OOP STRUCTURE, OBJECT, CLASS VARIABLES AND METHODS, PUBLIC VARIABLES AND METHODS, STATIC VARIABLES AND METHODS, 
# CONSTRUCTOR AND DESTRUCTOR,OBJECTS CLASS, MODULES AND PACKAGES
...
# ✅ PART 1: `object` Class in Python (The Root of Everything)
#🔹 What is the `object` class?
# In Python, **everything is an object**. Every class you create **automatically inherits from `object`** if you don’t specify anything else.
#🔹 Why is it important?

# * It is the **base class** for all new-style classes (since Python 3).
# * It provides default implementations for basic methods like:
#   * `__str__()`, `__repr__()`
#   * `__eq__()`, `__ne__()`
#   * `__hash__()`, `__sizeof__()` etc.
...
#🔸 Inheritance from `object` (Explicit vs Implicit)

# class A(object):  # Explicit inheritance
#     pass

# class B:          # Implicit (still inherits from object)
#     pass
# Both are the same in Python 3. All classes are "new-style" classes (unlike Python 2 where it mattered).

#✅ PART 2: Modules in Python OOP
#🔹 What is a Module?

# A **module** is simply a **Python file** (`.py`) that can contain:

# * Functions
# * Classes (most relevant to OOP)
# * Variables
# You can **import** and use them in other Python files.

#🔸 Example: Creating and Importing Classes from a Module
# **`vehicle.py`** (a module)
...
#✅ PART 3: Packages in Python OOP
#🔹 What is a Package?

# A **package** is a **folder/directory** that contains **modules** and a special file called `__init__.py`.
...
# **Each `.py` file is a module**. Together, they form a **package**.
...
#✅ Why Use Modules & Packages in OOP?

# | Feature           | Why it Helps in OOP                              |
# | ----------------- | ------------------------------------------------ |
# | **Modularity**    | Organize code logically (like `car`, `bike`)     |
# | **Reusability**   | Use classes across projects                      |
# | **Encapsulation** | Hide internal details, expose only what’s needed |
# | **Scalability**   | Large apps can grow easily                       |

# ✅ Recap Mind Map (Desi-style)

#                     OOP in Python
#                           |
#      --------------------------------------------------
#      |                   |                           |
#   object class         Modules                   Packages
#      |                   |                           |
# Base class of all    .py file with               Folder with
# classes              class definitions           multiple modules
#      |                   |                           |
# Provides basic       Import class from            Use __init__.py
# methods              one file to another          to make it usable
